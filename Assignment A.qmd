...
4.  The assignment is worth 100 points, and is due on **23rd April 2026 at 11:59 pm**.
...
## Q1 Randomization vs Blocking {.unnumbered}
...
2. The effect of typist on the typing time can be considered as a random variable with constant variance, and thus can be combined with the random error due to unknown factors. Typists within the same department are as similar as typists across departments.
...
## Q2 Expected bias in randomization {.unnumbered}
...
Use a statistical model to derive an expression for the expected bias in the estimated typing time difference of the two keyboards (1) using randomization *(use the randomized design on slide 15 of the class presentation "1. Introduction.pdf")*, and (2) using balanced randomization.
...
## Q3 Hypothesis testing {.unnumbered}
...
## Q4 Type I vs Type II error {.unnumbered}
...
## Q5 Randomization vs Blocking with random effects {.unnumbered}
...
Derive the condition, when the expected precision of the estimated difference in means of the hardness measured by the two tips will be higher in the experimental design of 5(b) as compared to the experimental design in 5(a). Use the square of the width of the confidence interval as a surrogate for precision.
