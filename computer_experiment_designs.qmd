...
Let us compare the projections of a 20-run 2-dimensional design with that of a 20-run 20-dimensional design on a two-dimensional subspace.
...
The best 20-run MmLHD for $p = 20$ is with seed:
...
Let us visualize the projections of the 20 run 2-dimensional MmLHD, and the 20-run 20-dimensional MmLHD on a 2-dimensional subspace, where the subspace is the subspace of the first two predictors.
...
We observe that the projections of the 20-dimensional MmLHD are not as space-filling in the 2-dimensional subspace as the projections of the 2-dimensional MmLHD.
...
We will use the seed to visualize the projections of a 20-run MaxProLHD and MaxPro design in 20 dimensions on a 2-dimensional subspace.
