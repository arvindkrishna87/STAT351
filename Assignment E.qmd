...
Will the expected GDP per capita of a country for a given female life expectancy from the model developed in  be different from the model developed only based on the country's continent data?

#### 

Will the confidence interval of the GDP per capita of a country for a given female life expectancy from the model developed in  be different from the model developed only based on the country's continent data?

#### 

What is the advantage of one approach over the other, and vice-versa? In other words, what is the advantage of the approach of developing a single model in contrast to developing separate models for distinct continents. And, what is the advantage of the approach of developing developing separate models for distinct continents in contrast to developing a single model for all continents.
