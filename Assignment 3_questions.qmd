...
4.  The assignment is worth 100 points, and is due on **26th May 2026 at 11:59 pm**.
...
9. To maintain family-wise error-rate, use Tukey's correction, wherever needed.  This is to ensure consistency of solutions.
...
Has the width of the confidence interval obtained in the previous question reduced as compared to that in 3(f)? If yes, then why? Given the same number of data points in Qs 3 and 4, why will the width reduce in 4(h) as compared to that in 3(f)?
