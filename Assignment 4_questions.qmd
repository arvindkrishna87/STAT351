...
8. For questions involving derivations (Q3 in this assignment), you are allowed to do them on paper, scan and upload separately. However, you are welcome to type the derivations in this template.
...
Suppose the computer model is given by the [borehole function](https://www.sfu.ca/~ssurjano/borehole.html). Develop a simple-kriging metamodel, and a universal-kriging metamodel for each of the following 10-run designs: 
